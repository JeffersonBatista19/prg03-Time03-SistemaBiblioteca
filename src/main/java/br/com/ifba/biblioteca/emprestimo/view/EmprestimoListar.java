...
// Variável para controlar o filtro da tabela
    ...
    private void configurarTabela() {
        ...
        // 2. Cria um modelo de tabela (onde os dados ficam guardados)
        ...
        // 3. Aplica esse modelo na sua tabela visual (tblEmprestimos)
        tblEmprestimos.setModel(modelo);
        
        // 4. AQUI É A MÁGICA DA BUSCA (O tal do Passo 3)
    ...
    private void btnAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdicionarActionPerformed
      try {  
        // 1. Pega a tela de Adicionar que o Spring criou
            EmprestimoAdicionar telaAdicionar = context.getBean(EmprestimoAdicionar.class);
            
            // 2. Passa a referência desta lista (para atualizar a tabela depois)
            ...
            // 4. Mostra a janela diretamente! (Sem criar JDialog)
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        // 2. Converte índice visual para modelo (por causa da busca/filtro)
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        try {
            ...
            // Supondo que você criou EmprestimoEditar.java
            // Se não criou ainda, comente as duas linhas abaixo para não dar erro
